...
import secrets
# importing login manager package and user loader for
# our db table
...
# Creating our mashaller to pull/create k,v pairs out of Drone attributes
...
#takes a python class object like <Drone x2395965634>
# and interates it through our fields and adds them into a dictionary as k,v pairs
def marshall(drone):
    a_dict = {}
    fields = ['id', 'name','description', 'price', 'camera_quality', 'flight_time', 'max_speed', 'dimensions', 'weight', 'cost_of_prod', 'series']
    for field in fields:
